...
print(f"""
╔═══════════════════════════════════════════════════════════════════╗
║           ☁️  COMMUNITY CAPTIONER CLOUD SERVER ☁️                  ║
╠═══════════════════════════════════════════════════════════════════╣
║                                                                   ║
║  Landing Page:    http://0.0.0.0:{PORT}                            ║
║  Overlay URL:     http://0.0.0.0:{PORT}/overlay.html               ║
║  Download:        http://0.0.0.0:{PORT}/download/community-captioner.zip ║
║                                                                   ║
║  This server receives captions from local clients and             ║
║  serves them to OBS overlays.                                     ║
║                                                                   ║
