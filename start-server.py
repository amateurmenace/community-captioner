...
def speech_recognition_loop(mic_index=None):
    ...
    if not SPEECH_AVAILABLE:
        print("âŒ Speech recognition not available")
        return
    ...
    print(f"ðŸŽ¤ Starting speech recognition (mic_index={mic_index})...")
    ...
    try:
        ...
        print(f"âŒ Error initializing microphone: {e}")
...
â•‘              ðŸŽ¤ COMMUNITY CAPTIONER SERVER ðŸŽ¤                      â•‘
â• â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•£
â•‘                                                                   â•‘
â•‘  LOCAL ACCESS:                                                    â•‘
...
â•‘                                                                   â•‘
â•‘  âž¤ Use the Network Overlay URL in OBS on another machine         â•‘
â•‘  âž¤ Set Browser Source dimensions to 1920 x 1080                  â•‘
â•‘                                                                   â•‘
â•‘  Python Speech Recognition: {"âœ… Available" if SPEECH_AVAILABLE else "âŒ Not Available"}               â•‘
â•‘                                                                   â•‘
